...
class PictureCreatorFrame(ttk.Frame):
    ...
    def generate_image(self,games_directory):
        img0 = pipeline(self.text_area.get("1.0", "end-1c").lower(),width=256, height=256).images[0]
        img1 = pipeline(self.text_area.get("1.0", "end-1c").lower(),width=256, height=256).images[0]
        img2 = pipeline(self.text_area.get("1.0", "end-1c").lower(),width=256, height=256).images[0]
        img3 = pipeline(self.text_area.get("1.0", "end-1c").lower(),width=256, height=256).images[0]
